...
description: Build and work with ndeblauw/blue-admin for flexible admin backends.
metadata:
...
## Overview
Apply this skill when creating or modifying admin CRUD resources using blue-admin. Triggers on: admin panel, blue-admin, admin crud, backend crud, resource admin. Covers creating routes, empty controllers, BlueAdmin config classes, FormRequests, _form.blade.php views, sidebar menu entries, and custom index/show views.
